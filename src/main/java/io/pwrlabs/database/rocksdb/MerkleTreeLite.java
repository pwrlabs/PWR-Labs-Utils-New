...
public class MerkleTreeLite {
    ...
    private static Map<String /*Tree Name*/, MerkleTreeLite> openTrees = new ConcurrentHashMap<>();
    //endregion
    ...
    //region ===================== Constructors =====================
    public MerkleTreeLite(String treeName) throws RocksDBException {
